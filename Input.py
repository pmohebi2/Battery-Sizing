...
def initialize_data(file_path):
    ...
    return (Netload_values, Tou_price, battery_cost, roundtrip_efficiency, Rate, 
            self_discharge, Projectlife, charge_power_capacity, discharge_power_capacity, 
            electricity_sell_price_ratio, CRF)
